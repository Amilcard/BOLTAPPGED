    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mt-8">
          <h3 className="font-semibold text-gray-800 mb-4">Contact Groupe &amp; Découverte</h3>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 text-sm">
            <div>
              <p className="text-gray-500 text-xs mb-1">Email</p>
              <p className="font-medium break-all">contact@groupeetdecouverte.fr</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="font-medium font-mono tracking-wide">06 12 34 56 78</p>
              <p className="text-xs text-gray-400">Urgences séjour uniquement</p>
            </div>
            <div>
              <p className="text-gray-500 text-xs mb-1">Réf. GED</p>
