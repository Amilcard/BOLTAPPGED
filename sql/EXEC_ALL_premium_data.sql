-- ============================================
-- SQL TOUT-EN-UN: Premium Data + Fusion Carrousels
-- À exécuter dans Supabase SQL Editor en une seule fois
-- ============================================
-- ÉTAPE 1: Remplir les 24 séjours (données marketing premium)
-- ÉTAPE 2: Remapper les carrousels (4→3) + corriger badges
-- ============================================

-- ========================
-- UNIVERS 1: SENSATIONS & ADRÉNALINE (12-17 ans)
-- ========================
...
-- AZUR DIVE & JET → Remonte dans ADRENALINE (séjour premium)
UPDATE gd_stays SET
...
-- ========================
-- UNIVERS 2: AVENTURE & DÉCOUVERTE (8-14 ans)
-- Fusion des anciens ALTITUDE_AVENTURE + OCEAN_FUN
-- ========================
...
-- ========================
-- UNIVERS 3: MA PREMIÈRE COLO (3-9 ans)
-- ========================
...
-- ========================
-- ÉTAPE FINALE: marketing_title DÉFINITIFS (ex-SQL 004 + 005)
-- Applique les renommages finaux en une seule passe
-- ========================
